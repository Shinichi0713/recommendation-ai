...
<img src="image/18_inner_product/1774744839087.png" width="700" style="display: block; margin: 0 auto;">
...
- `U` は対角成分が $e^{i\theta}, e^{-i\theta}$ のユニタリ行列です：
  ...
  \end{pmatrix}
  $$
- `U.conj().T @ U` が単位行列に近いことを確認し、ユニタリ性（$U^\dagger U = I$）を数値的に確かめています。
