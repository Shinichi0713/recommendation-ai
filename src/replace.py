...
# 実行設定
input_md = r"D:\PycharmProjects\ScienceCalculation\idea_thinking\optimization\basic\l2_convex.md"   # 変換元のファイル名
output_md = r"D:\PycharmProjects\ScienceCalculation\idea_thinking\optimization\basic\l2_convex.md" # 変換後のファイル名
is_note = False
