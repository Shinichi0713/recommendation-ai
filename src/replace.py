...
# 実行設定
input_md = r"D:\PycharmProjects\ScienceCalculation\recommendation-ai\anormaly_detect_techs\techs\tv_rpca\doc\singular_vestor.md"   # 変換元のファイル名
output_md = r"D:\PycharmProjects\ScienceCalculation\recommendation-ai\anormaly_detect_techs\techs\tv_rpca\doc\singular_vestor_replaced.md" # 変換後のファイル名
is_note = False
