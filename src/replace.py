...
# 実行設定
input_md = r"D:\PycharmProjects\ScienceCalculation\recommendation-ai\mathematics\linear_algebra\docs\22_tensor.md"   # 変換元のファイル名
output_md = r"D:\PycharmProjects\ScienceCalculation\recommendation-ai\mathematics\linear_algebra\docs\22_tensor_converted.md" # 変換後のファイル名
is_note = False
