...
今の課題は、この「境界線の誤報」を消したい、ということでしょうか？それとも、境界線が出ることを利用して何かを判別しようとされていますか？

Would you like to see how CRD would handle the same "road edge" scenario to suppress that false alarm?
